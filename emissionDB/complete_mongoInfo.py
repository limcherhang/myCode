...
if __name__ == '__main__':
    ...
    with conn.cursor() as cursor:
        ...
        for cal in cal_approaches:
            ...
            replace_sql = f"""
                REPLACE INTO emissionFactor.mongoInfo(sId, _id, type, scope, typeOfEmission, category, categoryKey, nameKey, sourceType, usedRegion, sourceOfEmission, EFSId) VALUES {value_string}
            """
