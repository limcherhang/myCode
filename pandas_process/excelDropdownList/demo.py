...
# 创建一个示例数据帧
data = {'Equipment Name': ['' for _ in range(100)],
        'Age': ['' for _ in range(100)],
        'City': ['' for _ in range(100)]}

df = pd.DataFrame(data)

# 指定包含下拉列表的选项
dropdown_options1 = ['Option 1', 'Option 2', 'Option 3']
